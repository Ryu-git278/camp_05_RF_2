...
//todo;配列を初期化させているので、for(int i = 0; i <1;i++) この分は必要だった！！
//1人目・宮脇さん、
//トライキャッチ文（違う回答が入った場合NGアラート）
//コンティニュー文（↑その場合に再度入力）
//do while 構文
...
//4人目・荒木さん
//質問辞退を変数に設定することで、選択式1～4回答を偏りなく答えを出せるようにしている！
//別途：ポケモンゲーム面白そう！！すごい

//5人目・カブラキさん
//質問回答事態を複数用してrandom表示させる

//6人目・木島さん
//ドラクエ風サイト 戦って倒すか、逃げるで終了させる
